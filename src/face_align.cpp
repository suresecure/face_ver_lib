...
// Align of ligntened-cnn, mxnet version.
cv::Rect  FaceAlign::detectAlignCropLigntenedCNNMxnet(cv::Mat & cv_img,
                                           cv::Mat & face,
                                           const int crop_size,
                                           const float ts,
                                           cv::Rect rect,
...
// Align of ligntened-cnn, author original version.
cv::Rect  FaceAlign::detectAlignCropLigntenedCNNOrigin(cv::Mat & cv_img,
                                                       cv::Mat & face,
                                                       const int crop_size,
                                                       const int ec_mc_y,
                                                       const int ec_y,
